...
describe("neobar (registry + setup)", function()
    ...
    describe("setup()", function()
        ...
        it("registers diagnostics/debug/test/run/terminal when enabled (default)", function()
            neobar.setup()
            assert.is_not_nil(neobar.get("diagnostics"))
            assert.is_not_nil(neobar.get("debug"))
            assert.is_not_nil(neobar.get("test"))
            assert.is_not_nil(neobar.get("run"))
            assert.is_not_nil(neobar.get("terminal"))
        end)
