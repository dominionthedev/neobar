...
describe("neobar.config", function()
    describe("resolve()", function()
        it("returns the full defaults when called with no opts", function()
            ...
            assert.are.same("left", resolved.position)
            assert.are.same(5, resolved.width)
            assert.are.same(true, resolved.exclusive)
            assert.are.same("left", resolved.slots.explorer.side)
            assert.are.same("bottom", resolved.slots.terminal.side)
